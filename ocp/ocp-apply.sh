...
oc process -f ../ocp/jhipstersampleapplication/jhipstersampleapplication-mysql.yml | oc apply -f -
oc process -f ../ocp/jhipstersampleapplication/jhipstersampleapplication-deployment.yml | oc apply -f -
